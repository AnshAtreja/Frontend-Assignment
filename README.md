...
1. **Enter JSON Schema:**
    ...
    Open the application in your browser, and you'll see an input area. Enter a valid JSON schema to generate the dynamic form. Example JSON :-
...
3. **Submit the Form:**
    ...
    Fill out the form fields as per the generated structure. Click the "Submit" button to view the collected form data in the console logs.
